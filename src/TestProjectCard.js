...
const ProjectCard = ({
  ...
  const contractSharesAvailable = shares; // read from the contract on every update
  const contractNAV = nav; // Read from the contract on load
        ...
        <div className="is-flex is-flex-direction-row is-justify-content-space-between is-align-content-space-between">
          ...
          <div className="is-flex is-justify-content-center is-align-items-center">
            <div className="is-right">
              <button disabled={true} className="button is-primary is-right">
                Place order
              </button>
            </div>
          </div>
